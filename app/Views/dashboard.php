...
<body id="dashboard">
    <div class="container mt-4">
        ...
        <div class="welcome-container">
            <h1 class="position-absolute" style="color: #C45A01; z-index: 1; font-size: 40px; font-weight: bold; padding-bottom: 120px; padding-right: 27%;">
                Selamat Datang Anya Callissta Chriswantari
            </h1>
            <img src="/assets/img/background-dashboard.jpg" alt="Background" class="img-fluid" style="height: 100%; width: 100%;">
        </div>
        <!-- Cards -->
        <div class="row mt-4">
            <!-- Card 1 -->
